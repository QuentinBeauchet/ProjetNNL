...
class PopUp:
    def __init__(self, canvas):
        ...
        self.canvas.wm_attributes(*(['-topmost', True] if platform.system()
                                  == "Windows" else ['-type', 'splash', '-topmost', True]))
    ...
    def setButtons(self, boxes):
        ...
        Button(self.canvas, text="DEL",
               command=boxes.delete).grid(row=2, column=1)
